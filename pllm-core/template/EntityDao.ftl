...
public class ${className} extends JdbcDao<${modelClassName}> implements ${daoInterfaceName} {
     ...
     */
	@Override
	public Pager<${modelClassName}> findAllPaged(<#list queryFields as e>${e.beanType} ${e.beanName} <#if e_has_next>,</#if> </#list>){
		String sql="select * from ${modelClassName}";
		Map<String,Object> params=new HashMap<String,Object>();
		<#list queryFields as e>
		params.put("${e.beanName}", ${e.beanName});
		</#list>
