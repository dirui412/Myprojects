...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" role="form">
				...
				<label class="col-sm-2 control-label no-padding-right" for="queryEquipmentType">设备类型</label>
				<div class="col-sm-4">
					<input type="text" id="queryEquipmentType" name="queryEquipmentType" class="col-xs-10 col-sm-5" />
				</div>
			</div>
				...
				<div class="row">
					<form id="formInput" class="form-horizontal" role="form" >
						...
						<div class="form-group">
							...
							<label class="col-sm-2 control-label no-padding-right"
								for="inputEquipmentType">设备类型</label>
							<div class="col-sm-4">
								<input type="text" id="inputEquipmentType" name="inputEquipmentType"  required />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"
...
<script type="text/javascript">
								...
								.DataTable(
										{
											...
											"ajax" : {
												...
												data : function(d) {
													...
													d.queryEquipmentType=$("#queryEquipmentType").val();
												},
	...
	function editObject(rowIndex) {
		...
		$("#inputEquipmentType").val(row["equipmentType"]);
	...
	function postObject() {
		...
		obj.equipmentType=$("#inputEquipmentType").val();
