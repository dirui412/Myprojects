	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form">
		    <div class="form-group">
				...
				<label class="col-sm-2 control-label no-padding-right" for="queryProductType">生产线类型</label>
				<div class="col-sm-4">
					<input type="text" id="queryProductType" name="queryProductType" class="col-xs-10 col-sm-5" />
				</div>
			</div>
				...
				<div class="row">
					<form id="formInput" class="form-horizontal" role="form" >
						...
						<div class="form-group">
							...
							<label class="col-sm-2 control-label no-padding-right"
								for="inputProductType">生产线类型</label>
							<div class="col-sm-4">
								<input type="text" id="inputProductType" name="inputProductType"  required />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"
				...
				<div class="row">
					<div class="col-xs-12 col-sm-5">
						<form id="formProductLineEquipments" class="form-horizontal" role="form">
							<h5 class="header smaller lighter blue">可选权限</h5>
							<div class="form-group">
								<c:forEach var="item" items="${equipmentInfos}">
									<div class="checkbox">
										<label> <input name="checkboxEquipmentId"
											value="${item.equipmentId}" type="checkbox" class="ace" /> <span
											class="lbl">${item.equipmentName}</span>
										</label>
									</div>
								</c:forEach>
							</div>
								...
								.DataTable(
										{
											...
											"ajax" : {
												...
												data : function(d) {
													...
													d.queryProductType=$("#queryProductType").val();
												},
