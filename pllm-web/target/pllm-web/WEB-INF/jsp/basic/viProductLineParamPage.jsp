...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" role="form">
		    <input type="hidden" id="queryProductLineId" name="queryProductLineId"  value="${productLineId}" />
			...
			<div class="modal-body">
				<div class="row">
					<form id="formInput" class="form-horizontal" role="form" >
						<input type="hidden" id="hiddenProductLineParamId" name="hiddenProductLineParamId" />
						<input type="hidden" id="inputProductLineId" name="inputProductLineId" value="${productLineId}" />
						<div class="form-group">
								...
								.DataTable(
										{
											...
											"ajax" : {
												...
												data : function(d) {
													...
													//alert(str);
													d.queryProductLineId=$("#queryProductLineId").val();
													d.queryParamName=$("#queryParamName").val();
													d.queryParamType=$("#queryParamType").val();
												},
