					...
					<form id="formInput" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"
								for="textParamName">参数名称</label>
							<div class="col-sm-4">
								<input type="text" id="textParamName" name="textParamName"
								 readonly required />
							</div>
							<label class="col-sm-2 control-label no-padding-right"
								for="textParamValue">参数值</label>
							<div class="col-sm-4">
								<textarea id="textParamValue" name="textParamValue"
									required></textarea>
							</div>
						</div>
...
<script src="assets/js/jquery.validate.min_cn.js"></script>
<script type="text/javascript">
	...
	function editObject(rowIndex) {
		...
		$("#hiddenAreaId").val(row["paramId"]);
		$("#textParamName").val(row["paramName"]);
		$("#textParamValue").val(row["paramValue"]);
		$('#divInputForm').modal();
	}
	...
	//提交对象
	function postObject() {
		var strData = "paramId=" + $("#hiddenAreaId").val();
		strData = strData + "&paramName="  + $("#textParamName").val();
		strData = strData + "&paramValue=" + $("#textParamValue").val();
		alert(strData);
		$.ajax({
			type : "post",
			url : "../sys/sysParams/post",
			data : strData,
			datatype : "json",
