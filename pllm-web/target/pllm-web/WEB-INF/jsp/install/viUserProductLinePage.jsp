					...
					<form id="formInput" class="form-horizontal" role="form" >
						...
						<div class="form-group">
						    <label class="col-sm-2 control-label no-padding-right"
								for="inputUserProductLineName">用户生产线</label>
							<div class="col-sm-4">
								<input type="text" id="inputUserProductLineName" name="inputUserProductLineName" class="form-control" required ></textarea>
							</div>
							<label class="col-sm-2 control-label no-padding-right"
...
<script type="text/javascript">
											...
											"columnDefs" : [
													...
													} ,
													{
														...
														"render" : function(
																...
																row, meta) {
															var str = '<div class="center" >';
															if(row["productLineState"]=="选型中" ||row["productLineState"]=="已选型" || row["productLineState"]=="安装中")
															    str = str+ '<a class="edit-row" href="javascript:userEquipments('
															        + data
															        + ')" >生产线设备</a>';
															else
																str=str+"";
	...
	//用户设备
	function userEquipments(userProductLineId)
	{
		var url = "../install/viUserEquipmentPage?userProductLineId=" + userProductLineId;
		//alert(url);
		var title = "《生产线选型》生产线设备";
