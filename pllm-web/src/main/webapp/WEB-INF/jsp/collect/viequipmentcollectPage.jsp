	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form">
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="queryUserProductLineName">用户生产线名</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="queryParaName">参数名称</label>
				<div class="col-sm-4">
					<input type="text" id="queryParaName" name="queryParaName" class="col-xs-10 col-sm-5" />
				</div>
			</div>
								...
								.DataTable(
										{
											...
											"ajax" : {
												url : '../collect/viequipmentcollect/',
												type : 'get',
												data : function(d) {
                                                    ...
                                                    d.queryParaName=document.getElementById("queryParaName").value;
												},
