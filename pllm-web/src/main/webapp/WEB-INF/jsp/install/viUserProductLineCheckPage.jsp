...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" role="form">
		    <input type="hidden" name="queryGroupId" id="queryGroupId" value="${groupId}" /> <!-- 此处groupId用于过滤显示的信息 -->
					...
					<form id="formInput" class="form-horizontal" role="form" >
                        ...
                        <div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"
								for="inputUserProductLineName">客户生产线名称</label>
							<div class="col-sm-4">
								<input type="text" id="inputUserProductLineName" name="inputUserProductLineName"  readonly />
							</div>
							<label class="col-sm-2 control-label no-padding-right"
								for="inputProductName">生产线原型</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"
								for="inputGroupName">客户单位</label>
							<div class="col-sm-4">
								<input type="text" id="inputGroupName" name="inputGroupName"  readonly />
							</div>
							<label class="col-sm-2 control-label no-padding-right"
								for="inputProductLineState">生产线状态</label>
							<div class="col-sm-4">
								<input type="text" id="inputProductLineState" name="inputProductLineState"  readonly />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="inputCheckTime" name="inputCheckTime"  size="16" type="text" required /> <span class="addon">
